...
public class StageManager
{
    ...
    public final static String REPAIR_ON_WRITE_STAGE = "REPAIR-ON-WRITE-STAGE";
    ...
    static
    {
        ...
        stages.put(REPAIR_ON_WRITE_STAGE, multiThreadedStage(REPAIR_ON_WRITE_STAGE, getConcurrentReaders()));
    }
